...
function genPassword() {
  ...
  // this will run iterations of the code  X number of times . if 5 it will run for 5 random letters
  //  random number - is the new variable for random number selected - idex selected .
  ...
  /*  
         ...
         - for each cycle random number will be created , it is selecting the bu index. 
          - nwo we need to select the index number from the list 
          we only want 1 character at a time so the argument for the substring is between 
          random number and random number +1
          - 
  ...
  //    tis is the syntax for retrieving info to link it with the html
}
